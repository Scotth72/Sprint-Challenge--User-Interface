...
HTML gives meaning to the page to identify what is on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Inline-block does not add a line break after the element. Block does allow a line break after the element.
...
Develops are able to work on group projects and they also are able to have version control with git.
